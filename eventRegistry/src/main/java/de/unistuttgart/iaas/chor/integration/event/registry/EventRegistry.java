...
public interface EventRegistry {
	...
	public ActivityInstance getActivityInstanceByElementModelID(String uuid);
	...
	public Iteration createIteration(String iterationID, RepetitionMethodEnum repetitionMethod, ActivityInstance initialRewindingPoint, ProcessInstance initialStartParticipant, Map<ProcessInstance, Tuple> rewindingPointMap, List<MessageLinkInstance> messageLinkInstances, ChoreographyInstance choreographyInstance, String view);
...
//	public CorrelationInstance getCorrelationInstance(Correlation correlation, String propertyValue);
	...
	//=========================================================================================================
	// Breakpoint registration related methods
	//=========================================================================================================
