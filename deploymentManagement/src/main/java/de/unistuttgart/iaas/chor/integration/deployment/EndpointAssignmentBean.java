...
public class EndpointAssignmentBean {

	private ManagementRegistry managementRegistry;
	private EventRegistry eventRegistry;

	
	public Object assignEndpoints(@Headers Map<String, Object> headers, @Body ProcessBundleType processBundleType) {
		
		headers.put(CxfConstants.OPERATION_NAMESPACE, "http://www.apache.org/ode/deployapi");
		headers.put(CxfConstants.OPERATION_NAME, "deploy");
		...
		while (endpointIter.hasNext()) {
			...
			if (serviceName != null && serviceName.equals("DeploymentService")) {
				...
				headers.put(Exchange.DESTINATION_OVERRIDE_URL, endpointData.getEndpointURL());
			}
