...
@XmlRootElement(name = "ChorUndeploymentEventMessage", namespace = "http://www.example.org/choreography_deployment_message")
public class ChorUndeploymentEventMessage {
