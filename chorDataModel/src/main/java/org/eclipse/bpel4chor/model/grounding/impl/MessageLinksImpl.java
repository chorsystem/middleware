 ...
 * <ul>
 *   <li>{@link org.eclipse.bpel4chor.model.grounding.impl.MessageLinksImpl#getMessageLink <em>Message Link</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MessageLinksImpl extends EObjectImpl implements MessageLinks
{
        ...
        {
                return GroundingPackage.Literals.MESSAGE_LINKS;
        }
        ...
        public EList<MessageLink> getMessageLink()
        {
                if (messageLink == null)
                {
                        messageLink = new EObjectContainmentEList<MessageLink>(MessageLink.class, this, GroundingPackage.MESSAGE_LINKS__MESSAGE_LINK);
                }
                return messageLink;
        }
        ...
        public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
        {
                switch (featureID)
                {
                        case GroundingPackage.MESSAGE_LINKS__MESSAGE_LINK:
