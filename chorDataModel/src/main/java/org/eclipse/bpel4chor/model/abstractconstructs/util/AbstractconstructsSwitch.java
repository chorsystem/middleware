 ...
 * @generated
 */
public class AbstractconstructsSwitch<T> {
	/**
	 ...
	 * @generated
	 */
	public AbstractconstructsSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AbstractconstructsPackage.ABSTRACT_ACTIVITY: {
				AbstractActivity abstractActivity = (AbstractActivity)theEObject;
				T result = caseAbstractActivity(abstractActivity);
				if (result == null) result = caseExtensionActivity(abstractActivity);
				if (result == null) result = caseActivity(abstractActivity);
				if (result == null) result = caseExtensibleElements(abstractActivity);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AbstractconstructsPackage.ABSTRACT_CONNECTOR: {
				AbstractConnector abstractConnector = (AbstractConnector)theEObject;
				T result = caseAbstractConnector(abstractConnector);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AbstractconstructsPackage.ABSTRACT_CONTAINER: {
				AbstractContainer abstractContainer = (AbstractContainer)theEObject;
				T result = caseAbstractContainer(abstractContainer);
				if (result == null) result = caseExtensionActivity(abstractContainer);
				if (result == null) result = caseCLinkable(abstractContainer);
				if (result == null) result = caseActivity(abstractContainer);
				if (result == null) result = caseExtensibleElements(abstractContainer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
