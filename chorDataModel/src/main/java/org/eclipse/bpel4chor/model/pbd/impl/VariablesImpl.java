 ...
 * <ul>
 *   <li>{@link org.eclipse.bpel4chor.model.pbd.impl.VariablesImpl#getVariable <em>Variable</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VariablesImpl extends ExtensibleElementsImpl implements Variables {
	...
	protected EClass eStaticClass() {
		return PbdPackage.Literals.VARIABLES;
	}
	...
	public EList<Variable> getVariable() {
		if (variable == null) {
			variable = new EObjectContainmentEList<Variable>(Variable.class, this, PbdPackage.VARIABLES__VARIABLE);
		}
		return variable;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PbdPackage.VARIABLES__VARIABLE:
