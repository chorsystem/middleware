 ...
 * <ul>
 *   <li>{@link org.eclipse.bpel4chor.model.pbd.impl.ExtensionsImpl#getExtension <em>Extension</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ExtensionsImpl extends ExtensibleElementsImpl implements Extensions {
	/**
	...
	protected EClass eStaticClass() {
		return PbdPackage.Literals.EXTENSIONS;
	}
	...
	public EList<Extension> getExtension() {
		if (extension == null) {
			extension = new EObjectContainmentEList<Extension>(Extension.class, this, PbdPackage.EXTENSIONS__EXTENSION);
		}
		return extension;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PbdPackage.EXTENSIONS__EXTENSION:
