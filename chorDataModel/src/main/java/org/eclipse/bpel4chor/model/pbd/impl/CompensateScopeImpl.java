 ...
 * <ul>
 *   <li>{@link org.eclipse.bpel4chor.model.pbd.impl.CompensateScopeImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CompensateScopeImpl extends ActivityImpl implements CompensateScope {
	...
	protected EClass eStaticClass() {
		return PbdPackage.Literals.COMPENSATE_SCOPE;
	}
	...
	public void setTarget(String newTarget) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PbdPackage.COMPENSATE_SCOPE__TARGET, oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PbdPackage.COMPENSATE_SCOPE__TARGET:
				return getTarget();
		}
