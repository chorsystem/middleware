 ...
 * <ul>
 *   <li>{@link org.eclipse.bpel4chor.model.pbd.impl.SourcesImpl#getSource <em>Source</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SourcesImpl extends ExtensibleElementsImpl implements Sources {
	/**
	...
	protected EClass eStaticClass() {
		return PbdPackage.Literals.SOURCES;
	}
	...
	public EList<Source> getSource() {
		if (source == null) {
			source = new EObjectContainmentEList<Source>(Source.class, this, PbdPackage.SOURCES__SOURCE);
		}
		return source;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PbdPackage.SOURCES__SOURCE:
