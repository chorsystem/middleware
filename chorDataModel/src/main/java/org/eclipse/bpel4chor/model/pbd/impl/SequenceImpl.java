 ...
 * <ul>
 *   <li>{@link org.eclipse.bpel4chor.model.pbd.impl.SequenceImpl#getActivity <em>Activity</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SequenceImpl extends ActivityImpl implements Sequence {
	...
	protected EClass eStaticClass() {
		return PbdPackage.Literals.SEQUENCE;
	}
	...
	public EList<Activity> getActivity() {
		if (activity == null) {
			activity = new EObjectContainmentEList<Activity>(Activity.class, this, PbdPackage.SEQUENCE__ACTIVITY);
		}
		return activity;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PbdPackage.SEQUENCE__ACTIVITY:
